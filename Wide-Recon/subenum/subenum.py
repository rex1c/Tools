...
def subdomain_enumertaion():
    ...
    for i in domain_lst:
        ...
        # static 
        os.system(" shuffledns -w sub.merged -d {} -r resolver -silent -o {}.sub.static.txt".format(i,i))
        # dynamic  
        ...
        os.system(" shuffledns -w {}.sub.combined.txt -d {} -r resolver -silent -o {}.sub.dynamic.txt".format(i,i,i))
